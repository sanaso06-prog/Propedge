  ...
  try {
    const res = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: "user",
          content: `Search for ${playerName} NBA 2025-26 season stats. Find: current season ${propType} average, last 5 games ${propType} stats, last 10 games ${propType} average, injury report today, and tonight's opponent. Return ONLY a JSON object like this with real numbers you found:
{"seasonAvg":25.5,"last5Avg":28.1,"last10Avg":27.4,"last5Games":[31,28,25,29,27],"injuryStatus":"Healthy","injurySeverity":0,"opponent":"Toronto Raptors","opponentTeam":"TOR","isBackToBack":false,"daysRest":2}`
        }]
      })
    });
